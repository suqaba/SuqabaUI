...
def makeResultShow(doc, name="ResultMechanical"):
...
def makeSolverSuqaba(doc, name="SolverSuqaba"):
    """makeSolverSuqaba(document, [name]):
    makes a Suqaba solver object"""
    import femsolver.suqaba.solver

    obj = femsolver.suqaba.solver.create(doc, name)
    return obj
